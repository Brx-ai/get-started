...
import { example_single } from '../schemas/example_schemas.ts';
import dotenv from 'dotenv';

// Displaying the chat iterator schema
console.log(example_single);
...
let brxObject = new BRK(example_single);

// These are the names of the input vars set
brxObject.input['user-input'].value = "What color is the sky?";
